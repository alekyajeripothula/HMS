                    ...
                    <div class="account-settings">
                        <div class="user-profile">
                            <div class="user-avatar">
                                <img src="https://img.freepik.com/free-vector/doctor-character-background_1270-84.jpg?w=2000" alt="Maxwell Admin">
                            </div>
                        ...
                        <div class="about">
                            <h5>About</h5>
                            <p>Welcome Doctor, <?php echo $name; ?></p>
                        </div>
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Consultation Fee</label>
                                    <input type="text" class="form-control" name="amount" placeholder="Consultation fee" required>
                                </div>
                                <div class="form-group">
